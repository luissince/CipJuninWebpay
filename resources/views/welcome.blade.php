...
@section('title','CIP VIRUTAL - JUNÍN')
...
<div class="row">
    <div class="col-xs-6">
        ...
        <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
            Tendra un panel donde podra visualizar sus datos principales.
        </p>
    </div>
    <div class="col-xs-6">
...
<div class="row">
    <div class="col-xs-6">
        ...
        <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
            En esta sección podra realizar sus pagos de cuotas ordinarias y certificados de tipo A, B, C.
        </p>
    </div>
    <div class="col-xs-6">
